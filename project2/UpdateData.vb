Public Class UpdateData
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        Dim strSql = "UPDATE customerdata SET nameD = '" & strName & "', age = '" & strAge & "', address = '" & strAddress & "',
        phoneNum = '" & strphoneNum & "', gender = '" & strGender & "' WHERE idcus = " & idCustomer
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        Dim strSql As String = "DELETE FROM customerdata WHERE idcus = " & idCustomer
        Try
